...
parser.add_argument('--ckpt_path', default="/mnt/home_6T/public/jayliu0313/check_point/mil_test/Nmap_Rec/best_ckpt.pth")
## "/mnt/home_6T/public/jayliu0313/check_point/mil_test/Nmap_Rec/best_ckpt.pth"
parser.add_argument('--output_dir', default="./output")
parser.add_argument('--dataset_type', default="eyecandies")
parser.add_argument('--method_name', default="nmap_rec", help="mean_rec, rec, recur_rec, nmap_rec, memory")
