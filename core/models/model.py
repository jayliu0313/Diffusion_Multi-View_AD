...
class Model(torch.nn.Module):
    ...
    def forward_pc_features(self, x):
        xyz_features, center, ori_idx, center_idx = self.xyz_backbone(x)
...
class Group(nn.Module):
    ...
    def forward(self, xyz):
        ...
        neighborhood, center, ori_idx, center_idx = sample_and_group(xyz,  self.num_group, self.group_size, radius=0.5, knn=True)
