...
parser.add_argument('--ckpt_path', default="checkpoints/rgb_checkpoints/finetune_condition_diffusion_unet3")
...
class Pipline():
    def __init__(self, clip_id="openai/clip-vit-base-patch32", diffusion_id="CompVis/stable-diffusion-v1-4", revision="ebb811dd71cdc38a204ecbdd6ac5d580f529fd8c"):
        self.device =  torch.device("cuda" if torch.cuda.is_available() else "cpu")
        # self.weight_type = weight_type
        # Load CLIP Image Encoder
        self.clip_encoder = CLIPVisionModel.from_pretrained(clip_id).to(self.device)
    ...
    def run(self, args):
        ...
        for epoch in range(args.epoch, args.num_train_epochs):
            ...
            for lightings, _ in tqdm(train_dataloader):
                ...
                latents = self.get_vae_latents(lightings.to(self.device))
